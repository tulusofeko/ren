...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['prefix' => 'user', 'as' => 'user.'], function () {
        ...
        Route::get('/get/{email?}', 'UserController@get')->name('get')
            ->middleware(['auth']);
        ...
        Route::delete('/hapus/{id}', 'UserController@delete')->name('delete')
            ->middleware(['auth']);
        
        Route::any('/logout', 'UserController@logout')->name('logout');
        
        Route::any('/dtbl', 'UserController@data')->name('datatables')
            ->middleware(['auth']);
    });
